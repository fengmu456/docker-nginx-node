...
${bold}${NODENAME} is no longer actively supported!${normal}
   ...
   * ${green}https://deb.nodesource.com/setup_8.x 鈥� Node.js 8 LTS \"Carbon\"${normal} (recommended)
   * ${green}https://deb.nodesource.com/setup_10.x 鈥� Node.js 10 Current${normal}
